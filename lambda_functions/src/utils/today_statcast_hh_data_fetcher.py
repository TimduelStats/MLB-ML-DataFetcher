...
class FangraphsStatcastScraper:
    ...
    def generate_url(base_url, start_date):
        ...
        return f"{base_url}?pos=all&stats=bat&lg=all&season=2024&season1=2024&ind=0&team=0&pageitems=2000000000&qual=5&type=24&month=1000&&startdate={start_date_str}&enddate={end_date_str}"
